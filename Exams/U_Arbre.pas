...
type
   ...
   // accede à l'élement situé le plus a gauche possible dans a
...
// Recopie arbre binaire en un arbre binaire doublement lié
// Après exécution de la procédure, l"arbre initial est toujours
// présent en mémoire.
...
(* remarque:
 ...
 et on a :
 => E(log2(n)) <= h <= n-1
 E(x) partie entiere inferieure du réel x.
 
 arbre dégénéré :
 si chacun de ses noeuds possede qu'un et un seul fils excepté le noeud 
 ...
 arbre complet :
 si ses noeuds possèdent tous le meme nombre de fils et
 ...
 tous les noeuds du dernier niveaux doivent etre regroupé à gauche.
  
 arbre équilibré :
 si pour chacun de ses noeuds, la difference de hauteur
 entre le sous arbre le plus haut et le moins haut n'excède pas 1.
